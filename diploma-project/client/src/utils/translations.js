...
fundsComingSoon: "Здесь будет управление экологическими фондами и их финансированием",
  ...
  fundsMarkerCountMismatch: "Количество меток должно совпадать с количеством деревьев в запросе",
...
ticketClosedSuccess: "Обращение {ticketNumber} закрыто",
    ...
    petPlayBtn: "Поиграть",
    petGameTitle: "Игра с питомцем",
    petGameStart: "Нажми пробел или тапни чтобы начать",
    petGameHint: "Прыгай через препятствия!",
    petGameOver: "Игра окончена!",
    petGameScore: "Счёт",
    petGameBest: "Рекорд",
    petGameRestart: "Нажми пробел или тапни для рестарта",
    petGameCoinsEarned: "экоинов получено!",
    petGameCoinsAlready: "Экоины уже получены сегодня",
    petGameLeaderboard: "Рейтинг",
    petGameNoPlayers: "Сегодня ещё никто не играл",
...
achievements: "достижений",
  ...
  EN: {
    ...
    petPlayBtn: "Play",
    petGameTitle: "Pet Game",
    petGameStart: "Press Space or tap to start",
    petGameHint: "Jump over obstacles!",
    petGameOver: "Game Over!",
    petGameScore: "Score",
    petGameBest: "Best",
    petGameRestart: "Press Space or tap to restart",
    petGameCoinsEarned: "eco coins earned!",
    petGameCoinsAlready: "Eco coins already claimed today",
    petGameLeaderboard: "Leaderboard",
    petGameNoPlayers: "No one has played today yet",
    petStatsTitle: "📊 Stats",
...
fundsComingSoon: "Eco-funds management coming soon",
  ...
  fundsMarkerCountMismatch: "Number of markers must match the number of trees in the request",
...
achievements: "achievements",
  ...
  BY: {
    ...
    petPlayBtn: "Пагуляць",
    petGameTitle: "Гульня з хатнім жывёлам",
    petGameStart: "Націсні прабел або тапні каб пачаць",
    petGameHint: "Скачы праз перашкоды!",
    petGameOver: "Гульня скончана!",
    petGameScore: "Лік",
    petGameBest: "Рэкорд",
    petGameRestart: "Націсні прабел або тапні для рэстарту",
    petGameCoinsEarned: "экамонет атрымана!",
    petGameCoinsAlready: "Экаманеты ўжо атрыманы сёння",
    petGameLeaderboard: "Рэйтынг",
    petGameNoPlayers: "Сёння яшчэ ніхто не гуляў",
...
fundsComingSoon: "Тут будзе кіраванне экалагічнымі фондамі і іх фінансаваннем",
  ...
  fundsMarkerCountMismatch: "Колькасць метак павінна адпавядаць колькасці дрэў у запыце",
