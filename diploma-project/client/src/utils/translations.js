...
ticketClosedSuccess: "Обращение {ticketNumber} закрыто",
    ...
    petVacationRule2: "Экоины не тратятся",
    petVacationRule3: "XP за этот день не начисляется",
    petVacationRule4: "Доступно 3 раза в месяц",
...
achievements: "достижений",
  ...
  EN: {
    ...
    petVacationRule2: "No eco-coins spent",
    petVacationRule3: "No XP earned today",
    petVacationRule4: "Available 3 times per month",
...
achievements: "achievements",
  ...
  BY: {
    ...
    petVacationRule2: "Экамонеты не трацяцца",
    petVacationRule3: "XP за гэты дзень не налічваецца",
    petVacationRule4: "Даступна 3 разы ў месяц",
