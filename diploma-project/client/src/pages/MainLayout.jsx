...
const MainLayout = ({ translations: propTranslations, currentLanguage, onLanguageChange }) => {
  // Используем пропсы или fallback к локальному состоянию
  const [selectedLanguage, setSelectedLanguage] = useState(() => currentLanguage || getSavedLanguage())
  ...
  const handleLanguageSelect = (language) => {
    ...
    if (onLanguageChange) {
      ...
      saveLanguage(language) // Fallback для обратной совместимости
    }
    setIsDropdownOpen(false)
  }
