...
- Socket.IO Client - обновления в реальном времени
- Recharts - графики и диаграммы
- Material Icons - иконки
- Vite - сборка проекта
...
- express-rate-limit - защита от атак
- cors - настройка CORS
...
npm install
cd diploma-project/client && npm install
...
Все библиотеки установятся автоматически. Размер зависимостей: ~350 MB.
